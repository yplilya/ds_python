...
# installed.
TK_PREFIX='/home/ypl/module_3/ds_python/test_env'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/ypl/module_3/ds_python/test_env'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/ypl/module_3/ds_python/test_env/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/ypl/module_3/ds_python/test_env/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/ypl/module_3/ds_python/test_env/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/tmp/build/80754af9/tk_1592503156360/work/tk8.6.10/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/ypl/module_3/ds_python/test_env/lib/libtkstub8.6.a'
